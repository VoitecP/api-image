...
class APIUrls(APIView):
    ...
    def get(self,request):
        data={
            "Root                           ": "http://127.0.0.1:8000/api/                  Docker: http://192.168.99.100:8000/api/",
            f"Admin Panel,                   ": "http://127.0.0.1:8000/api/admin/           Docker: http://192.168.99.100:8000/api/admin/", 
            f"":"",
            f"Upload Image Endpoint          ": "http://127.0.0.1:8000/api/userimage/       Docker: http://192.168.99.100:8000/api/userimage/",
            "Image Detail View              ":"http://127.0.0.1:8000/api/userimage/1/       Docker: http://192.168.99.100:8000/api/userimage/1/",
            # "Upload Image Endpoint, generic ": "http://127.0.0.1:8000/api/generic/userimage/1",
            "User's Gallery, paginated      ": "http://127.0.0.1:8000/api/gallery/1/        Docker: http://192.168.99.100:8000/api/gallery/1/",
            "Example Endpoint for Token     ": "http://127.0.0.1:8000/api/token/<hash>      Docker: http://192.168.99.100:8000/api/token/<hash>",
            ".":".",
            "Below List of Api Endpoint generated by Router, and Nested Router": "",
            ".":".",
            "Api v2 Routed                  ":"http://127.0.0.1:8000/api/v2/                Docker: http://192.168.99.100:8000/api/v2/",
        }
